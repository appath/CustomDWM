...
# it'll load a random theme each time that zsh is loaded.
ZSH_THEME="ra"
...
# Set personal aliases, overriding those provided by zsh libs,
# plugins, and themes. Aliases can be placed here, though zsh
