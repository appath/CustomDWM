...
static const char colors[NUMCOLORS][MAXCOLORS][8] = {
	...
	{ "#f9f9f9",	 "#f5f5f5", 	  "#262626" },
	{ "#000000", 	 "#f5f5f5", 	  "#dd2200" },
	{ "#1d1f21", 	 "#c5c8c6", 	  "#1d1f21" },
	{ "#1d1f21", 	 "#7a7a7a", 	  "#1a1a1a" },
	{ "#1d1f21",     "#6e6e6e",       "#1d1f21" },
	{ "#1d1f21",     "#c5c8c6",       "#c5c8c6" },
	{ "#1d1f21",     "#c5c8c6",       "#c5c8c6" },
};

// tagging
static const char *tags[] = { ">> ", "DEVELOPMENT ", "PENTEST ", "MISC ", "SSH ", "[ Name:KEY ] " };
...
/* 
 * dmenu_run config info
 * "-fn", "SF Mono:size=9" vector font
 * "-w", "320" menu width
 * "-x", "70" indent from the left edge of the screen
 * "-y", "50" indent from the top of the screen
 * "-l", "10" 10-line vertical menu
 * "-dim", "0.4" darkens the background 40%
 */
static const char *dmenucmd[] 	    = { "dmenu_run", "-i", "-p", "PKG Search:", "-fn", "SF Mono:size=9", "-w", "320", "-h", "20", "-x", "70", "-y", "50", "-dim", "0.4", NULL };
